        ...
        <div className="w-full max-w-sm rounded-lg bg-white shadow-md">
            ...
            <div className="px-5 pb-5">
                ...
                <div className="mt-2.5 mb-5 flex items-center">
                    ...
                    <span className="mr-2 ml-3 rounded bg-rose-200 px-2.5 py-0.5 text-xs font-semibold text-rose-700">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <a
                        href="#"
                        className="rounded-lg bg-rose-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-rose-800 focus:outline-none focus:ring-4 focus:ring-rose-300"
                    >
                        Add to cart
                    </a>
                </div>
    ...
    return (
        <>
            ...
            <section className="bg-gray-100">
                ...
                <div className="flex flex-row justify-around space-x-5 py-10 px-10">
                    <Cards
