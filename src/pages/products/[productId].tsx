                    ...
                    <div className="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex items-center">
                                ...
                                <a href="#" className="ml-3 text-sm font-medium text-rose-600 hover:text-rose-500">117 reviews</a>
                            </div>
                        </div>
                        ...
                        <form className="mt-10">
                            ...
                            <div className="mt-10">
                                <div className="flex items-center justify-between">
                                    ...
                                    <a href="#" className="text-sm font-medium text-rose-600 hover:text-rose-500">Size guide</a>
                                </div>
                            ...
                            <button type="submit" className="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-rose-600 py-3 px-8 text-base font-medium text-white hover:bg-rose-700 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2">Add to bag</button>
                        </form>
                    </div>
